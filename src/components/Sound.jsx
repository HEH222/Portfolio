...
const Modal = ({ onClose, toggle }) => {
  return createPortal(
    <div className="fixed inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center z-[999]">
      <div
  ...
  return (
    <div className="fixed top-4 right-2.5 xs:right-4 z-50 group">
      ...
      <audio ref={audioRef} loop volume={0.3}>
        <source src="/audio/inspire.mp3" type="audio/mpeg" />
      ...
      <motion.button
        ...
        name={isPlaying ? "Mute background music" : "Play background music"}
      >
        {isPlaying ? (
          <Volume2
